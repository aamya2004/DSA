...
{  //Approach2
    private:
        void insert(Node* &copyHead, Node* &copyTail, int data){
    ...
    Node *copyList(Node *head)
    {
        ...
        Node* temp = head;
        while(temp!=NULL){
            insert(copyHead, copyTail, temp->data);
            temp = temp -> next;
        }
        ...
        while(cloneNode!=NULL && originalHead!=NULL){
            Node* next1 = originalHead->next;
       ...
       while(originalHead!=NULL){
           if(originalHead->next!=NULL){
               originalHead->next->arb = originalHead->arb ? originalHead->arb->next : originalHead->arb;
